...
//perRepo.Save(new Person {Name = "Bilbo", Phone = "159536482" , City = new City {Id = 1}});

/*
var newFred = new Person(){
...
perRepo.Update(111,newFred);
perRepo.Update(123,newJose);
perRepo.Update(213,newChico);
*/
...
void listaGeral()
{
    ...
    foreach (var person in allPeople)
    {
        ...
        var mostraCidade = person.City == null ? "" : person.City.Name;
        Console.WriteLine($"Id: {person.Id}\t|Nome: {person.Name}\t|Phone: {person.Phone}\t|Cidade: {mostraCidade}");
    }
    Console.WriteLine("---------------");
}
